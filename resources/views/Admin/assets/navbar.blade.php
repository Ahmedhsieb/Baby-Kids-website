...
<head>
    ...
    <link href="{{asset('AdminAssets/assets/css/elements/infobox.css')}}" rel="stylesheet" type="text/css">
...
{{--                        user img--}}
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="Teacher" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.teacher.create')}}"> Add Teacher </a>
                        </li>
                        <li>
                            <a href="{{route('admin.teacher.index')}}"> Teachers Table </a>
                        </li>
                    </ul>
                </li>

                <li class="menu">
                    <a href="#Activity" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled" id="Activity" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.activity.create')}}"> Add Activity </a>
                        </li>
                        <li>
                            <a href="{{route('admin.activity.index')}}"> Activities Table </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="Contacts" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.contact.index')}}"> Contacts Table </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="Courses" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{route('admin.course.index')}}"> Courses Table </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="Faqs" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.faqs.create')}}"> Add Faq </a>
                        </li>
                        <li>
                            <a href="{{route('admin.faqs.index')}}"> Faqs Table </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="Sliders" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{route('admin.slider.index')}}"> Sliders Table </a>
                        </li>
                    </ul>
                </li>
